...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Test\Downloads\EverythngAbby\zuri\ZURI_DJANGO\.env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Test\Downloads\EverythngAbby\zuri\ZURI_DJANGO\.env\Scripts\deactivate.nu'
